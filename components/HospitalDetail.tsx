...
import { 
  ArrowLeft, Mail, Phone, FileText, Send, Brain, Sparkles, X, ShoppingCart, Check, Edit, User, Wand2, Calendar, MapPin, Activity, Building2
} from 'lucide-react';
import { 
  BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer 
} from 'recharts';
import { Hospital, Note, Contact, UsageRecord, ProductType, SalesStage, UsageType, ActivityType, HospitalLevel } from '../types';
        ...
        {activeTab === 'overview' && (
            <div className="space-y-6 animate-fade-in">
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 lg:p-8">
                    <h2 className="text-lg font-bold text-slate-900 mb-6">設備狀態</h2>
