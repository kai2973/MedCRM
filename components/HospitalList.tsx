...
import { Hospital, SalesStage, HospitalLevel } from '../types';
...
const HospitalList: React.FC<HospitalListProps> = ({ hospitals, onSelectHospital, onAddHospital }) => {
  ...
  const handleCreate = () => {
    ...
    setNewHospital({ name: '', address: '', region: '', level: HospitalLevel.LOCAL, stage: SalesStage.LEAD });
  };
      ...
      <div className="bg-white p-5 rounded-2xl shadow-sm border border-slate-200/60 mb-6 transition-all focus-within:ring-2 focus-within:ring-blue-100">
        <div className="flex flex-col md:flex-row gap-4 justify-between items-center">
          ...
          <button 
            ...
            className={`w-full md:w-auto flex items-center justify-center space-x-2 px-4 py-2.5 rounded-xl border font-medium transition-colors ${
              isFilterOpen || activeFilters.stage !== 'All' || activeFilters.region !== 'All'
