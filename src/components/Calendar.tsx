        ...
        <div className="flex items-center space-x-2">
          ...
          {isManagerOrAdmin && allProfiles.length > 0 && (
            <div className="relative" data-dropdown>
              ...
              {showFilterMenu && (
                <div className="absolute left-1/2 -translate-x-1/2 sm:left-auto sm:translate-x-0 sm:right-0 top-full mt-2 w-48 bg-white rounded-xl shadow-xl border border-slate-200 z-[9999] py-1 max-h-64 overflow-auto">
                  <button
          ...
          <div className="relative" data-dropdown>
            ...
            {showExportMenu && (
              <div className="absolute right-0 top-full mt-2 w-44 bg-white rounded-xl shadow-xl border border-slate-200 z-[9999] py-1">
